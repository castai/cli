...
func (c *client) GetClusterFeedbackEvents(ctx context.Context, clusterID sdk.ClusterId) ([]sdk.KubernetesClusterFeedbackEvent, error) {
	resp, err := c.api.GetClusterFeedbackEventsWithResponse(ctx, clusterID)
	if err != nil {
		return nil, err
	}
